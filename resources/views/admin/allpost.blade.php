        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    @if (session('status'))
                        <div style="background-color: lightgreen;" class="alert
                        alert-success">
                            {{ session('status') }}
                        </div>
                    @endif
                            ...
                            <tbody>
                                ...
                                <tr style="border-bottom: 1px solid #ddd;">
                                    ...
                                    <td style="padding: 12px 15px;">
                                        <a href="{{route('admin.update',$posts->id)}}" style=
                                        "background-color: #2196F3; color:
                                        white; border: none; padding: 6px 12px;
                                         border-radius: 4px; cursor: pointer;
                                          margin-right: 5px;">Update</a>
                                    </td>
                                    <td style="padding: 12px 15px;">
                                        <a href="{{route('admin.deletepost',
                                        $posts->id)}}" style="background-color:
                                        #f44336; color: white; border: none;
